...
export class DeploymentSlotsComponent extends FeatureComponent<TreeViewInfo<SiteData>> implements OnDestroy {
    ...
    protected setup(inputEvents: Observable<TreeViewInfo<SiteData>>) {
        return inputEvents
            ...
            .do(r => {
                ...
                this.canScaleUp = this.siteArm && this._scenarioService.checkScenario(ScenarioIds.canScaleForSlots, { site: this.siteArm }).status !== 'disabled';
    ...
    private _updateDisabledState() {
        ...
        this.swapSlotsCommandDisabled = this.saveAndDiscardCommandsDisabled || !this.hasSwapAccess || !this.relativeSlotsArm || !this.relativeSlotsArm.length;
    ...
    private _openSwapPane() {
        ...
        this._portalService.openBlade(bladeInfo, this.componentName)
            .do(null, err => {
                this.clearBusy();
                this.swapControlsOpen = false;
                this._updateDisabledState();
            ...
            .mergeMap(swapResult => {
                ...
                if (!location) {
                    ...
                    return Observable.interval(pollingInterval)
                        ...
                        .map(_ => { return { success: true, error: null }; })
    ...
    receiveAddParams(params: AddSlotParameters) {
        ...
        if (!params) {
            ...
            this._siteService.createSlot(params.siteId, params.newSlotName, params.location, params.serverFarmId, params.cloneConfig)
                .subscribe(r => {
                    this.dirtyMessage = null;
