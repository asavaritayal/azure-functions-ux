...
const routing: ModuleWithProviders = RouterModule.forChild([
    {
        ...
        children: [
            ...
            {
                path: 'subscriptions/:subscriptionId/resourcegroups/:resourceGroup/providers/microsoft.web/sites/:site/deploymentslots/actions/swap',
                loadChildren: 'app/ibiza-feature/swap-slots-shell/swap-slots-shell.module#SwapSlotsShellModule',
            },
            {
                path: 'subscriptions/:subscriptionId/resourcegroups/:resourceGroup/providers/microsoft.web/sites/:site/slots/:slot/deploymentslots/actions/swap',
                loadChildren: 'app/ibiza-feature/swap-slots-shell/swap-slots-shell.module#SwapSlotsShellModule',
            },
            {
                path: 'subscriptions/:subscriptionId/resourcegroups/:resourceGroup/providers/microsoft.web/sites/:site/deploymentslots/actions/add',
                loadChildren: 'app/ibiza-feature/add-slot-shell/add-slot-shell.module#AddSlotShellModule',
            },
            {
                path: 'subscriptions/:subscriptionId/resourcegroups/:resourceGroup/providers/microsoft.web/sites/:site/slots/:slot/deploymentslots/actions/add',
                loadChildren: 'app/ibiza-feature/add-slot-shell/add-slot-shell.module#AddSlotShellModule',
            },
            {
